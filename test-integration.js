...
async function runTests() {
    ...
    try {
        ...
        const response = await makeRequest('/test-integration.html');
        const body = response.body;
        const hasSectionIds = body.includes('id="hero"') && body.includes('id="services"') && body.includes('id="gallery"') && body.includes('id="contact"');
        const hasNavLinks = body.includes('href="#hero"') && body.includes('href="#services"') && body.includes('href="#gallery"') && body.includes('href="#contact"');
...
//# sourceURL=src/tests/test-integration.ts